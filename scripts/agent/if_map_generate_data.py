...
class IF_Agent_trajectory(BaseAgent):
    ...
    def reset(self, output_dir='outputs/tmp'):
        ...
        if self.config.environment == 'habitat':
            subfolders = ["rgb", "depth", "semantic", 
                          ...
                          "combined", "point_cloud_debug", "fov"
                          ]
...
class IF_Agent_traversability(BaseAgent):
    ...
    def reset(self, output_dir='outputs/tmp'):
        ...
        if self.config.environment == 'habitat':
            subfolders = [
                        #   "generated_pixel_1",
                        #   "generated_pixel_1_json",
                        #   "generated_pixel_2",
                        #   "generated_pixel_2_json",
                        #   "generated_pixel_3",
                        #   "generated_pixel_3_json",
                        # # for visualization
                        #   "semantic", "semantic_room",
                        #   "full_occupancy_explore", "local_occupancy_explore", "full_occupancy_explore_frontier", 
                        #   "full_occupancy_explore_frontier_gt", "local_occupancy_explore_frontier", "local_occupancy_explore_frontier_gt",
                        # "combined","fov", 'rgb', 'depth', 'top_down_map',
                        "traversability_mask"
                          ]
        elif self.config.environment == 'real_world':
            # TODO
...
class IF_Agent_pixel(BaseAgent):
...
class IF_Agent_history(BaseAgent):
    ...
    def reset(self, output_dir='outputs/tmp'):
        ...
        # 640 x 480
        obs, info = self.envs.reset(config_mapping,
                                    return_info=True)
        self.observation = obs
        self.info = info
        ...
        # Process observations
        rgbd = np.concatenate((obs['rgb'].astype(np.uint8),
                               obs['depth']), axis=2)
        self.raw_obs = rgbd[:, :, :3]
        self.raw_depth = rgbd[:, :, 3]
        ...
        base_dir = f"{self.scene_id}/{self.ep_id}"
        if self.config.environment == 'habitat':
            subfolders = ["rgb", "depth", "semantic", "semantic_room",
                          "sem_pred_maskrcnn", "sem_pred_grounding_sam2",
                          "top_down_map",
                          "his_tra_single_colored",
                          "his_tra_multip_colored",
                          "his_tra_without_colored",
                          "point_cloud_debug",
                          "combined_debug",
    ...
    def step(self, best_action):
        ...
        self.seg_idx_obj = obs['semantic_id']
        self.seg_name_obj = obs['semantic_name']
        # self.seg_idx_region = obs['semantic_region_id']
...
class IF_Agent_rotate(BaseAgent):
...
class IF_Agent_history_SIFT(BaseAgent):
    ...
    def reset(self, output_dir='outputs/tmp'):
        ...
        if self.config.environment == 'habitat':
            subfolders = ["rgb", "depth", "semantic", "semantic_room",
                          ...
                          "full_occupancy_explore", "local_occupancy_explore", "full_occupancy_explore_frontier", 
                          "full_occupancy_explore_frontier_gt", "local_occupancy_explore_frontier", "local_occupancy_explore_frontier_gt",
                        "combined","fov", "his_cv_straight", "his_cv_turn"
                          ]
        elif self.config.environment == 'real_world':
            # TODO
            subfolders = ["rgb", "depth", "semantic", "maskrcnn", "bev", "occ"]
